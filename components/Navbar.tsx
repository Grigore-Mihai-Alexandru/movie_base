...
export default Navbar;
    ...
    // const handleClickOutside = (event:Event,sidebarRef:any) => {
    //     if (sidebarRef.current && sidebarRef.current.contains(event.target) ){
    //         setSidebar(!sidebar)
    //         console.log("here")
    //         document.body.style.overflow = 'hidden'
    //     }
    //     else if(sidebarRef.current && sidebar &&!sidebarRef.current.contains(event.target)){
    //         setSidebar(false)
    ...
    // useEffect(() => {
    //     console.log(sidebar)
    //     document.addEventListener('click',(e) =>handleClickOutside(e,sidebarRef), true);
    //     return () => {
    //         document.removeEventListener('click', (e) =>handleClickOutside(e,sidebarRef), true);
    //     };
    // }, [ sidebarRef ]);
    
    // useEffect(() => {
    //     console.log(sidebar)
    //     document.addEventListener('click',(e) =>handleClickOutside(e,menuRef), true);
    //     return () => {
    //         document.removeEventListener('click', (e) =>handleClickOutside(e,menuRef), true);
    //     };
    // }, [ menuRef ]);
